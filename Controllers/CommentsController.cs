...
namespace SoftwareCatalogDatabaseASP.Controllers
{
    public class CommentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Text,SoftwareId")] Comments comments)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Text,SoftwareId")] Comments comments)
        {
            if (id != comments.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SoftwareCatalogDBContext.CommentsGroups'  is null.");
            }
            var comments = await _context.Comments.FindAsync(id);
            if (comments != null)
            {
